...
public class Monospace extends PageElementWithChild {
	...
	public Monospace(@Nullable PageElement content, @Nullable Integer fromPos, @Nullable Integer toPos) {
	...
	public PageElement clonePageElement() {
		if (child != null) {
			return new Monospace(child.clonePageElement(), fromPos, toPos);
		} else {
			return new Monospace(null, fromPos, toPos);
		}
	}
}
