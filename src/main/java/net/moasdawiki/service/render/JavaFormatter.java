...
/**
 * Stellt Java-Code formatiert inkl. Syntaxhervorhebung in HTML dar. Wird für
 * das @@-Tag benötigt.<br>
 * <br>
...
public class JavaFormatter {
	...
	private static final String[] KEYWORDS = { "return", "if", "else", "switch", "case", "default", "for", "while", "do", "break", "continue", "try", "catch",
	...
	private boolean insideMultilineComment; // mehrzeiliger Kommentar?
